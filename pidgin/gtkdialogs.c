...
/*	str = g_string_sized_new(4096);
    ...
    gtk_about_dialog_set_program_name(GTK_ABOUT_DIALOG(dlg), "Virgin v0.1");
    gtk_about_dialog_set_comments(GTK_ABOUT_DIALOG(dlg), "Virgin is a messaging client based on libpurple which is capable of "
		  "connecting to multiple messaging services at once. Virgin is written "
		  "in C using GTK+. Virgin is released, and may be modified and "
		  "redistributed,  under the terms of the GPL version 2 (or later).  "
		  "A copy of the GPL is distributed with Virgin. Virgin is copyrighted by "
		  "its contributors, a list of whom is also distributed with Virgin.  "
		  "There is no warranty for Virgin.");

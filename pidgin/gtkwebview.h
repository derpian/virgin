...
void pidgin_webview_add_text(PidginWebView *webview, const char *mes, const char *usr, const char *usra, const char *t);
void pidgin_webview_clear_text(PidginWebView *webview);
